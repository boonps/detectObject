...
pop_image = face.load_image_file("pop.jpeg")
boon_image = face.load_image_file("boon.jpg")
pop_face_encoding = face.face_encodings(pop_image)[0]
boon_face_encoding = face.face_encodings(boon_image)[0]

# ใบหน้าคนที่ต้องการรู้จำเป็นreference #คนที่2
oat_image = face.load_image_file("oat.jpeg")
...
known_face_encodings = [pop_face_encoding, oat_face_encoding, boon_face_encoding]
known_face_names = ["PONGKUL", "PRAMOTE", "PASURA"]
