...
fontname = "sthangluang"
language = 'sarun'
directory = "/Users/boonstation/"
...
for files in os.listdir(directory):
    ...
    if files.endswith(".tif"):
        ...
        os.system(rename)
        command = 'tesseract sarun.' + fontname + '.exp' + str(count) + '.tif sarun.' + fontname + '.exp' + str(
            count) + ' nobatch box.train.stderr'
        # print        command
        os.system(command)
        count = count + 1
